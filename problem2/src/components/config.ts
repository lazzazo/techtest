 ...
 * AppInput component
 */
export const APP_INPUT_GRAY = '#ECF1F7'; 
export const APP_INPUT_DEFAULT_BORDER = '#6996eb'; 

/**
 * AppSelection component
 */
export const APP_SELECTION_GRAY = '#ECF1F7'; 
export const APP_SELECTION_DEFAULT_BORDER = '#6996eb'; 

/**
 * AppButton component
 */
export const APP_BUTTON_THEME_COLOR = '#6996eb'; 
